...
parser.add_argument('--query_index', default=999, type=int, help='test_image_index')
parser.add_argument('--test_dir', default='/home/dm/datasets/CVUSA/val',type=str, help='./test_data')
